...
var waterWobbleSpeed = 5, waterWobbleDist = 0.05;
...
Water.prototype.act = function(step) {
  this.wobble += step * waterWobbleSpeed;
  var waterWobblePos = Math.sin(this.wobble) * waterWobbleDist;
  this.pos = this.basePos.plus(new Vector(0, waterWobblePos));
};
